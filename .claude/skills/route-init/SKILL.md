...
allowed-tools: Bash(/Users/stephen.offer/Desktop/llm-router/scripts/rt:*), Read, Write, Bash(diff:*), Bash(ls:*), Bash(cat:*), Bash(env:*)
...
2. Show the user what each change is worth before making it. Run
   `/Users/stephen.offer/Desktop/llm-router/scripts/rt savings` and quote the top two levers.
...
- `/route` is opt-in per task; it deliberately declines to route when the saving
